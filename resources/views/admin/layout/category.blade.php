...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <a class="navbar-brand" href="Change.php">Xin Chào <span style="color : orange"> </span></a>
...
z-index : 1000 ;" class="alert alert-success"> 
  ...
  <table class="table table-bordered">
    ...
    <td><center><a href="category_edit.php?id=&takes=copy"><button type="button" class="btn btn-primary">Copy</button> </a></center></td>
        <td> <center><a href="category_edit.php?id="><button type="button" class="btn btn-warning">Sửa</button> </a> </center></td>
        <td> <center> <button onclick="deleteMenuChildren()" type="button" class="btn btn-danger">Xóa</button></center></td>
     </tr>
