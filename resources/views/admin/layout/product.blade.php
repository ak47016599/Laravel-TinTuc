...
<div class="container p-3 my-3 border">
  ...
  <div class="show-all-file">
                ...
                <button onclick="deleteimage('')"type="button" class="btn btn-delete btn-danger">Xóa</button>
           </div>
...
<div class="form-group">
  ...
  <br/><span> </span>
  <input value="" name="giamoi" type="number" class="form-control" id="usr">
</div>
<div class="form-group">
  <label for="usr">Giá Cũ:</label>
  <br/><span>  </span>
  <input value="" name="giacu" type="number" class="form-control" id="usr">
</div>
<div class="form-group">
  <label for="usr">Nội Dung:</label>
  <br/><span> </span>
  <textarea type = "text" class="form-control" rows="5" id="content" name="lol"> </textarea>
</div>
