...
<div  class = "login-error" id = "erro3">Tài khoản hoặc mật khẩu không chính xác </div>
  ...
  <div class="login-for">
   <a href="<?php echo e(url('auth/redirect/facebook')); ?>">  <div class="facebook"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuK8RUd_XzvWaqk-gWMXWv1ycUEQnh2XNb4A&usqp=CAU" width="35" height="35"> <h1 id="text">Facebook </h1> <h1>Login width Facebook </h1></div> </a>
    <a href="<?php echo e(url('auth/google')); ?>"> <div class="email"><img src="https://www.barrownz.com/Content/Images/MegaMenuIcons/googleplusLogo.png" width="35" height="35"> <h1 id="text">Google+ </h1><h1>Login width Google+ </h1> </div></a>
  </div>
...
<?php /**PATH C:\xampp\htdocs\Laravel5.8\resources\views/admin/loginUser.blade.php ENDPATH**/ ?>